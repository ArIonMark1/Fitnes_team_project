...
`,AO=()=>p.jsx(QL,{children:p.jsxs("a",{href:"/users/google",children:[p.jsx("svg",{children:p.jsx("use",{href:`${ge}#icon-google`})}),p.jsx("span",{children:"Sign in with Google"})]})}),VL=()=>p.jsx(Yp,{children:p.jsx(Vn,{children:p.jsxs(YL,{children:[p.jsx("h2",{children:"Create account"}),p.jsx(BL,{children:"Thank you for your interest in our platform. To complete the registration process, please provide us with the following information."}),p.jsx(WL,{}),p.jsx(AO,{}),p.jsxs(HL,{children:["Already have account? ",p.jsx(qL,{to:"/signin",children:" Sign In"})]}),p.jsx(wy,{}),p.jsx(by,{})]})})}),KL=Q.div`
  width: 100%;
  max-width: 286px;
  display: flex;
  flex-direction: column;
